...
// Single pricing object — no more A/B/C variants
const PRICES = {
  free: { name: "Darmowy", price: 0, renders: 3, cta: "Zacznij za darmo", link: "/staging" },
  starter: { name: "Starter", price: 49, renders: 30, cta: "Dołącz do early access", link: null },
  pro: { name: "Pro", price: 99, renders: 100, cta: "Dołącz do early access", link: null },
  agency: { name: "Agencja", price: 249, renders: 500, cta: "Dołącz do early access", link: null },
} as const;
...
export default function LandingPage({ defaultTheme = "dark" }: { defaultTheme?: "dark" | "light" }) {
  ...
  const [modal, setModal] = useState<{ plan: string } | null>(null);
  ...
  const openEarlyAccess = (plan: string) => {
    setModal({ plan });
    setModalState("form");
  };
  ...
  const handleEarlyAccess = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("_subject", `Early Access WnetrzeAI - ${formData.get("plan")}`);
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Tak! Masz 3 darmowe rendery miesięcznie, bez podawania karty kredytowej. Wgraj zdjęcie, wybierz styl i zobacz efekt w 30 sekund.",
    },
    {
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-border">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <a href="/" className="flex items-center gap-2 group">
            ...
            <span className="text-xl font-bold tracking-tight hidden sm:inline">Wnętrze<span className="gradient-ai">AI</span></span>
          </a>
          <div className="flex items-center gap-2 sm:gap-4">
            <button
              onClick={toggleTheme}
              className="w-9 h-9 rounded-lg border border-border flex items-center justify-center text-text-secondary hover:text-text-primary hover:border-border-hover transition-all flex-shrink-0"
            ...
            <Link href="/staging" className="btn-primary text-sm !px-3 !py-2 sm:!px-5 sm:!py-3">
              <span className="hidden sm:inline">Wypróbuj staging</span>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="text-center lg:text-left animate-fade-in">
              ...
              <p className="body-large mb-8 max-w-lg mx-auto lg:mx-0">
                ...
                <span className="text-text-primary font-medium">Szybsza sprzedaż</span>, więcej zapytań.
              </p>
              ...
              <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-amber-500/10 border border-amber-500/20">
                ...
                <span className="text-xs text-amber-300">Beta — model AI w trakcie treningu, jakość stale rośnie</span>
              </div>
            </div>
            <div className="relative animate-fade-in stagger-2">
              <div className="card-gradient p-2">
                ...
                <div className="flex items-center justify-between px-2 py-3">
                  <span className="text-xs text-text-tertiary">Wizualizacja poglądowa — transformacja w 30 sekund</span>
                  <div className="inline-flex items-center gap-1.5 badge badge-accent text-[10px]">
              ...
              <div className="absolute -bottom-4 -left-4 bg-bg-tertiary border border-border rounded-xl p-4 shadow-2xl animate-float hidden lg:block">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-text-tertiary">czas generowania</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="card-featured text-center">
              ...
              <div className="text-4xl font-bold gradient-text">0 PLN</div>
              <p className="text-sm text-violet-300 mt-1">3 rendery/mies za darmo, gotowe w 30s</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: "hd", color: "fuchsia", title: "Jakość HD", desc: "Zdjęcia w pełnej rozdzielczości, gotowe na OLX i Otodom." },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="body-large max-w-xl mx-auto">
              Przesuń suwak aby zobaczyć transformację. Wizualizacje poglądowe — wyniki mogą się różnić.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={example.label}>
                ...
                <p className="text-sm text-text-tertiary text-center mt-3">{example.label} <span className="text-text-muted">(wizualizacja poglądowa)</span></p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-bg-secondary">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="body-large max-w-xl mx-auto">Przykładowe opinie (produkt w fazie beta)</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="body-large max-w-xl mx-auto">
              Szukamy <span className="text-text-primary font-semibold">pierwszych agentów</span> do beta testów. Pomóż kształtować produkt i zyskaj dożywotni dostęp ze zniżką.
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-xs text-text-muted mt-4">Brak zobowiązań &bull; 3 darmowe rendery</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="card flex flex-col">
              <div className="mb-6">
                <h3 className="text-lg font-semibold mb-1">Darmowy</h3>
                <p className="text-sm text-text-tertiary">Na start</p>
              </div>
              <div className="mb-6">
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold">0</span>
                  <span className="text-text-tertiary">PLN</span>
                </div>
                <p className="text-xs text-text-muted mt-1">na zawsze</p>
              </div>
              <ul className="space-y-3 mb-6 flex-grow">
                {[
                  <><strong className="text-text-primary" key="r">3 rendery</strong> / miesiąc</>,
                  "Wszystkie style (15+)",
              ...
              <Link href="/staging" className="btn-secondary w-full text-center">Zacznij za darmo</Link>
            </div>
            {/* Starter */}
            <div className="card flex flex-col">
              <div className="mb-6">
              ...
              <div className="mb-6">
                ...
                <p className="text-xs text-text-muted mt-1">= {(49 / 30).toFixed(1)} PLN za render</p>
              </div>
              <ul className="space-y-3 mb-6 flex-grow">
                {[
                  <><strong className="text-text-primary" key="r">30 renderów</strong> / miesiąc</>,
                  "Wszystkie style (15+)",
                  "Bez watermarku",
                  "Gotowe w 30 sekund",
                ].map((f, i) => (
              ...
              <button onClick={() => openEarlyAccess("Starter")} className="btn-secondary w-full">Dołącz do early access</button>
            </div>
            {/* Pro */}
            <div className="card-featured flex flex-col relative">
              ...
              <div className="mb-6 mt-2">
                ...
                <p className="text-sm text-text-tertiary">Dla top agentów</p>
              </div>
              <div className="mb-6">
                <div className="flex items-baseline gap-1">
                ...
                <p className="text-xs text-text-muted mt-1">= {(99 / 100).toFixed(2)} PLN za render</p>
              </div>
              <ul className="space-y-3 mb-6 flex-grow">
                {[
                  <><strong className="text-text-primary" key="r">100 renderów</strong> / miesiąc</>,
              ...
              <button onClick={() => openEarlyAccess("Pro")} className="btn-primary w-full">
            ...
            <div className="card flex flex-col">
              <div className="mb-6">
                <h3 className="text-lg font-semibold mb-1">Agencja</h3>
              ...
              <div className="mb-6">
                ...
                <p className="text-xs text-text-muted mt-1">= {(249 / 500).toFixed(2)} PLN za render</p>
              </div>
              <ul className="space-y-3 mb-6 flex-grow">
                {[
                  <><strong className="text-text-primary" key="r">500 renderów</strong> / miesiąc</>,
                  "Najszybsza kolejka",
              ...
              <button onClick={() => openEarlyAccess("Agencja")} className="btn-secondary w-full">Dołącz do early access</button>
            </div>
          </div>
          {/* Guarantee */}
      ...
      <section id="cta" className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-xl mx-auto text-center relative z-10">
          ...
          <p className="body-large mb-8">
            Wypróbuj Wnętrze<span className="gradient-ai">AI</span> za darmo — 3 rendery miesięcznie, bez karty kredytowej.
          </p>
          ...
          <p className="text-xs text-text-muted mt-4">3 darmowe rendery/miesiąc &bull; Bez zobowiązań</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/blog" className="text-sm text-text-tertiary hover:text-text-primary transition-colors">Blog</Link>
            </div>
            <div className="text-center md:text-right">
              ...
              <p className="text-[10px] text-text-muted mt-1">v{VERSION}</p>
            </div>
          </div>
        </div>
      </footer>
          ...
          <div className="bg-bg-secondary border border-border rounded-2xl p-6 w-full max-w-[420px] max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            {modalState === "form" && (
              <>
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold">Early Access — <span className="gradient-text">{modal.plan}</span></h3>
                ...
                <p className="text-sm text-text-secondary mb-6">Zapisz się na listę early access. Powiadomimy Cię gdy plan {modal.plan} będzie dostępny.</p>
                <form onSubmit={handleEarlyAccess} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input type="text" name="name" placeholder="Jan" required className="input" />
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="block text-sm text-text-secondary mb-2">Firma <span className="text-text-muted">(opcjonalne)</span></label>
                    <input type="text" name="company" placeholder="Biuro Nieruchomości XYZ" className="input" />
                  </div>
            ...
            {modalState === "loading" && (
              <div className="text-center py-12">
                ...
                <p className="text-text-secondary">Zapisujemy...</p>
              </div>
            )}
            {modalState === "success" && (
              <div className="text-center py-8">
                ...
                <h4 className="text-xl font-bold mb-2">Jesteś na liście!</h4>
                <p className="text-text-secondary">Powiadomimy Cię gdy plan {modal.plan} będzie dostępny. Dzięki za zainteresowanie!</p>
              </div>
            )}
          </div>
        </div>
