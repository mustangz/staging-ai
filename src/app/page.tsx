    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="text-center lg:text-left animate-fade-in">
              ...
              <p className="body-large mb-8 max-w-lg mx-auto lg:mx-0">
                ...
                <span className="text-white font-medium">40% więcej zapytań</span>, szybsza sprzedaż.
              </p>
            ...
            <div className="relative animate-fade-in stagger-2">
              <div className="card-gradient p-2">
                ...
                <div className="flex items-center justify-between px-2 py-3">
                  <span className="text-xs text-[#71717a]">Transformacja w 30 sekund</span>
                  <div className="flex items-center gap-1.5">
                    <div className="flex -space-x-1">
                      <div className="w-5 h-5 rounded-full bg-violet-500/30 border border-[#0a0a0f]" />
                      <div className="w-5 h-5 rounded-full bg-fuchsia-500/30 border border-[#0a0a0f]" />
                      <div className="w-5 h-5 rounded-full bg-amber-500/30 border border-[#0a0a0f]" />
                    </div>
                    <span className="text-xs text-[#71717a]">2,100+ agentów</span>
                  </div>
                </div>
              </div>
              <div className="absolute -bottom-4 -left-4 bg-[#1a1a25] border border-white/[0.08] rounded-xl p-4 shadow-2xl animate-float hidden lg:block">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-[#71717a]">więcej zapytań</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="heading-section mb-4">
              ...
              <span className="text-[#71717a]">wolniej i taniej</span>
            </h2>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="card border-red-500/20 bg-red-500/5 text-center">
              <p className="text-[#71717a] text-sm mb-1">Tradycyjny staging</p>
              <div className="text-4xl font-bold text-red-400">3 000 - 8 000 PLN</div>
              <p className="text-sm text-[#52525b] mt-1">+ 3-7 dni oczekiwania</p>
            </div>
            <div className="card-featured text-center">
              <p className="text-[#71717a] text-sm mb-1">Wnętrze<span className="gradient-ai">AI</span></p>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="body-large max-w-xl mx-auto">
              Szukamy <span className="text-white font-semibold">pierwszych 10 agentów</span> do beta testów. Pomóż kształtować produkt i zyskaj dożywotni dostęp ze zniżką.
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-xs text-[#52525b] mt-4">Tylko 10 miejsc &bull; Brak zobowiązań</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              <span className={`text-sm ${isYearly ? "text-[#a1a1aa]" : "text-white font-medium"}`}>Miesięcznie</span>
              <button
              ...
              <span className={`text-sm ${isYearly ? "text-white font-medium" : "text-[#a1a1aa]"}`}>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="card flex flex-col">
              <div className="mb-6">
                ...
                <p className="text-sm text-[#71717a]">Dla pojedynczych agentów</p>
              </div>
              <div className="mb-6">
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl font-bold">{getPrice(prices.starter)}</span>
                  <span className="text-[#71717a]">PLN/mies</span>
                </div>
                <p className="text-xs text-[#52525b] mt-1">{(getPrice(prices.starter) / 10).toFixed(2).replace(".", ",")} PLN za render</p>
              </div>
              <ul className="space-y-3 mb-8 flex-grow">
                {["10 renderów miesięcznie", "Standardowa kolejka", "Bez watermarku", "8 stylów wnętrz"].map((f, i) => (
                  <li key={i} className="flex items-center gap-3 text-sm"><CheckIcon /><span>{i === 0 ? <><strong className="text-white">10 renderów</strong> miesięcznie</> : f}</span></li>
                ))}
              </ul>
            ...
            <div className="card-featured flex flex-col relative">
              ...
              <div className="mb-6 mt-2">
                ...
                <p className="text-sm text-[#71717a]">Dla aktywnych agentów</p>
              </div>
              <div className="mb-6">
                <div className="flex items-baseline gap-1">
                ...
                <p className="text-xs text-[#52525b] mt-1">{(getPrice(prices.pro) / 50).toFixed(2).replace(".", ",")} PLN za render</p>
              </div>
              <ul className="space-y-3 mb-8 flex-grow">
                {[<><strong className="text-white" key="r">50 renderów</strong> miesięcznie</>, <strong className="text-white" key="p">Priorytetowa kolejka</strong>, "Bez watermarku", "Wszystkie style (15+)", "1 poprawka na render"].map((f, i) => (
            ...
            <div className="card flex flex-col">
              <div className="mb-6">
                ...
                <p className="text-sm text-[#71717a]">Dla biur nieruchomości</p>
              </div>
              <div className="mb-6">
                <div className="flex items-baseline gap-1">
                ...
                <p className="text-xs text-[#52525b] mt-1">{(getPrice(prices.agency) / 300).toFixed(2).replace(".", ",")} PLN za render</p>
              </div>
              <ul className="space-y-3 mb-8 flex-grow">
                {[<><strong className="text-white" key="r">300 renderów</strong> miesięcznie</>, "Najszybsza kolejka", "Nieograniczone poprawki", "Priorytetowe wsparcie", "Faktura VAT"].map((f, i) => (
                  <li key={i} className="flex items-center gap-3 text-sm"><CheckIcon /><span>{f}</span></li>
                ))}
              </ul>
          ...
          <div className="text-center mt-12">
            <div className="inline-flex items-center gap-2 text-sm text-[#71717a]">
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <div key={i} className={`faq-item ${openFaq === i ? "open" : ""} bg-[#12121a] rounded-xl border border-white/[0.08] overflow-hidden`}>
                <button className="faq-question px-8" onClick={() => setOpenFaq(openFaq === i ? -1 : i)}>
                  <span>{faq.q}</span>
                  <svg className="faq-icon text-[#71717a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
                <div className="faq-answer px-8">
                  <p className="text-[#a1a1aa] text-sm pb-4">{faq.a}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="cta" className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-xl mx-auto text-center relative z-10">
          ...
          <p className="text-xs text-[#52525b] mt-4">Bez spamu. Odezwiemy się tylko gdy produkt będzie gotowy.</p>
        </div>
      </section>
      ...
      {modal && (
        <div className="fixed inset-0 bg-[rgba(10,10,15,0.8)] backdrop-blur-lg z-[100] flex items-center justify-center p-4" onClick={() => setModal(null)}>
          <div className="bg-[#12121a] border border-white/[0.08] rounded-2xl p-6 w-full max-w-[420px] max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            {modalState === "form" && (
              <>
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold">Zamówienie <span className="gradient-text">{modal.plan}</span></h3>
                  <button onClick={() => setModal(null)} className="text-[#71717a] hover:text-white transition-colors">
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
                  </button>
                </div>
                <form onSubmit={handleCheckout} className="space-y-4">
                  <div className="bg-[#12121a] rounded-xl p-4 border border-white/[0.08]">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-[#a1a1aa]">Plan</span>
                      <span className="font-medium">{modal.plan}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-[#a1a1aa]">Cena</span>
                  ...
                  <div>
                    <label className="block text-sm text-[#a1a1aa] mb-2">Imię i nazwisko</label>
                  ...
                  <div>
                    <label className="block text-sm text-[#a1a1aa] mb-2">Numer karty</label>
                    <input type="text" name="card" placeholder="4242 4242 4242 4242" maxLength={19} className="input" />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm text-[#a1a1aa] mb-2">Data ważności</label>
                      <input type="text" name="expiry" placeholder="MM/RR" maxLength={5} className="input" />
                    </div>
                    <div>
                      <label className="block text-sm text-[#a1a1aa] mb-2">CVC</label>
                  ...
                  <p className="text-xs text-[#52525b] text-center">To demo. Karta nie zostanie obciążona.</p>
                </form>
              </>
            )}
            {modalState === "loading" && (
              <div className="text-center py-12">
                ...
                <p className="text-[#a1a1aa]">Przetwarzanie płatności...</p>
              </div>
            )}
            {modalState === "success" && (
              <div className="text-center py-8">
                ...
                <p className="text-[#a1a1aa]">Zapisaliśmy Cię na listę early access. Powiadomimy gdy będzie gotowy.</p>
              </div>
            )}
          </div>
        </div>
